...
class SpotLightShape extends createjs.Shape {
  ...
  drawContents(w, h) {
    ...
    // -------------------------
    {
      ...
      const size = w / 2;
      // もやっとした円
      this.graphics.beginRadialGradientFill([createjs.Graphics.getHSL(100, 80, 20, 0.60),
        createjs.Graphics.getHSL(0, 0, 0, 0.20)], [0.0, 1.0], dx, dy, 0, dx, dy, size)
    ...
    // -------------------------
    {
      ...
      const size = w / 3;
      // もやっとした円
      this.graphics.beginRadialGradientFill([createjs.Graphics.getHSL(60, 40, 40, 0.50),
